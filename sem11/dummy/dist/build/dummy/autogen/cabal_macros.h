...
/* package dummy-0.1.0.0 */
#ifndef VERSION_dummy
#define VERSION_dummy "0.1.0.0"
#endif /* VERSION_dummy */
#ifndef MIN_VERSION_dummy
#define MIN_VERSION_dummy(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_dummy */
...
#define CURRENT_COMPONENT_ID "dummy-0.1.0.0-7IFdyvwTzI63wRhPXkTpNU-dummy"
